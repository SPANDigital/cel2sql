...
// Note: JSON field-name escaping is now implemented per-dialect (see
// dialect/<name>/dialect.go escapeJSONFieldName + their tests). The former
// top-level escapeJSONFieldName in utils.go was unused and has been removed.
