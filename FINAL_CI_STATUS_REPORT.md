...
|----------|---------|----------|----------|
| **CI** | ✅ **PASSING** | Run #14 | Tests, builds, and codecov upload working |
| **golangci-lint** | ✅ **PASSING** | Run #14 | All linting issues resolved |
| **Security** | ⚠️ **FIXED** | Run #11 | Updated Go version and Nancy action |
